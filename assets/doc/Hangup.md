...
<br>
<!-- markdown doesn't handle single column tables very well
>>> 
  **ncidd.blacklist**|.  
  -------------------|   
  "TELEMARKETER"     |&nbsp;    
...
> > If your modem isn't listed, which is highly _likely_, you
...
<!-- leading dash in output removed for table readability -->
