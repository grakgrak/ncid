...
<header class="font-bold rounded-lg m-2 h-10 bg-gray-300">
	<ul class="flex justify-around pt-2 text-gray-700">
		...
		<li><Link target="__VoronPi__" href="https://192.168.1.141:4200">[VoronPi]</Link></li>
		...
		<li class="p-1 hover:bg-teal-500 hover:text-white rounded" on:click={() => (showModal = true)}>
			<svg
				width="18"
				height="18"
				viewBox="0 0 24 24"
